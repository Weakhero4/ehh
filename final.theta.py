...
while (1):
    ...
    if answer == ('y'):
        ...
        print("==================================================")
        print("|TO CANCEL THE ORDER                    |  CODE  |")
        print("--------------------------------------------------")
        print("|> Buffalo Wings                        |  [-1]  |")
        print("|> Garlic Parmesan Wings                |  [-2]  |")
        print("|> Wings Corner's Original Wings        |  [-3]  |")
        print("|> BBQ Flavored Wings                   |  [-4]  |")
        print("|> Spicy Wings                          |  [-5]  |")
        print("|> Iced Tea Pitcher                     |  [-6]  |")
        print("|> Lemonade Pitcher                     |  [-7]  |")
        print("|> Canned Soda                          |  [-8]  |")
        print("|> Cancel All                           |  [ 0]  |")
        print("==================================================")
            ...
            while (3):
                ...
                try:
                    ...
                    if (wingscode == 1):
                        ...
                        while (4):
                            ...
                            try:
                                ...
                                if received < total:
                                    ...
                                    #IF MONEY GIVEN BY CUSTOMER IS LESSER OF THE TOTAL AMOUNT, THEN IT WILL HELP 
                                    a = received - total
                                    b = a * -1
                                    print("Lack of ₱:", b , "to make ₱",total)
                                    ...
                                    #format of date Month/Day/Year
                                    y = datetime.datetime.now()
                                    #format codes of Local version of date is %x
                                    d = y.strftime("%x")

                                    #format of time Hour/Minute/Second
                                    x = datetime.datetime.now()
                                    #format codes of Local version of time is %X
                                    t = x.strftime("%X") 
                        ...
                        wings_1 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"Buffalo Wings Subtotal:₱{wings_1}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -2):
                        wings_2 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"Garlic Parmesan Wings Subtotal:₱{wings_2}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -3):
                        wings_3 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"Wings Corner's Original Wings Subtotal:₱{wings_3}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -4):
                        wings_4 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"BBQ Flavored Wings Subtotal:₱{wings_4}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -5):
                        wings_5 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"Spicy Wings Subtotal:₱{wings_5}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -6):
                        drinks_6 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"Iced Tea Pitcher Subtotal:₱{drinks_6}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -7):
                        drinks_7 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f"Lemonade Pitcher Subtotal:₱{drinks_7}")
                        print(f"Total:₱{total}")

                    elif (wingscode == -8):
                        drinks_8 = float(0)
                        total = float(wings_1) + float(wings_2) + float(wings_3) + float(wings_4) + float(wings_5) + float(drinks_6) + float(drinks_7) + float(drinks_8)
                        print(f" Canned Soda Subtotal:₱{drinks_8}")
                        print(f"Total:₱{total}")
